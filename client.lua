...
function PlayVictimScream(victimPed)
    if DoesEntityExist(victimPed) then
        ...
        local randomSound = screamSounds[math.random(#screamSounds)]
        PlayPain(victimPed, 7, 0)
        PlayAmbientSpeech1(victimPed, randomSound, "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR")
    end
end
...
function StartBlurEffect(duration)
...
function PlayPunchSound()
    PlaySoundFrontend(-1, "PUNCH_IMPACT", "WastedSounds", 0)
end
